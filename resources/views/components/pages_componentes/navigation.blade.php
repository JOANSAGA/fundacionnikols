<div class="sticky top-0 z-40 flex-wrap w-full bg-white shadow select-none overflow-ellipsis">
    <div x-data="{ open: false }" class="container p-2 mx-auto">
        ...
        <nav :class="{'flex': open, 'hidden': !open}" class="container flex flex-col items-center justify-center w-full mx-auto md:w-4/5 md:flex md:flex-row">
